...
train_loader = torch.utils.data.DataLoader(
    dataloader.AudiosetDataset('/Users/zmoad/Documents/Course/06.AST_Audio/AST/cough_eval_0.json', label_csv='/Users/zmoad/Documents/Course/06.AST_Audio/AST/newLabel_OnlyTwo.csv',
                                audio_conf=audio_conf), batch_size=1000, shuffle=False, num_workers=0, pin_memory=True)
mean=[]
std=[]
