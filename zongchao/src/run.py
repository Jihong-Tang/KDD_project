...
parser.add_argument("--dataset", type=str, default="audioset", help="the dataset used", choices=["audioset", "esc50", "speechcommands","cough"])
...
if args.model == 'ast':
    ...
    norm_stats = {'audioset':[-4.2677393, 4.5689974], 'esc50':[-6.6268077, 5.358466], 'cough':[-4.8191395, 6.315072], 'speechcommands':[-6.845978, 5.5654526]}
    target_length = {'audioset':1024, 'esc50':512, 'speechcommands':128, 'cough':128}
    # if add noise for data augmentation, only use for speech commands
    noise = {'audioset': False, 'esc50': False, 'speechcommands':True, 'cough':True}
